...
0;else{this._fnInfo();clearTimeout(this.s.stateTO);this.s.stateTO=setTimeout(function(){a.s.dt.oApi._fnSaveState(a.s.dt)},250);if(c<this.s.redrawTop||c>this.s.redrawBottom){var g=(this.s.displayBuffer-1)/2*this.s.viewportRows;Math.abs(c-this.s.lastScrollTop)>b.viewport||this.s.ani?(d=parseInt(this._domain("physicalToVirtual",c)/b.row,10)-g,this.s.topRowFloat=this._domain("physicalToVirtual",c)/b.row):(d=this.fnPixelsToRow(c)-g,this.s.topRowFloat=this.fnPixelsToRow(c,!1));0>=d?d=0:d+this.s.dt._iDisplayLength>
...
for(e("tbody tr:lt(4)",a).clone().appendTo(c);3>e("tr",c).length;)c.append("<tr><td>&nbsp;</td></tr>");e("div."+this.s.dt.oClasses.sScrollBody,d).append(b);d.appendTo("body");this.s.heights.row=e("tr",c).eq(1).outerHeight();d.remove()},_fnInfo:function(){if(this.s.dt.oFeatures.bInfo){var a=this.s.dt,b=this.dom.scroller.scrollTop,c=Math.floor(this.fnPixelsToRow(b,!1,this.s.ani)+1),d=a.fnRecordsTotal(),f=a.fnRecordsDisplay(),b=Math.ceil(this.fnPixelsToRow(b+this.s.heights.viewport,!1,this.s.ani)),b=
f<b?f:b,c=a.fnFormatNumber(c),b=a.fnFormatNumber(b),d=a.fnFormatNumber(d),f=a.fnFormatNumber(f),f=0===a.fnRecordsDisplay()&&a.fnRecordsDisplay()==a.fnRecordsTotal()?a.oLanguage.sInfoEmpty+a.oLanguage.sInfoPostFix:0===a.fnRecordsDisplay()?a.oLanguage.sInfoEmpty+" "+a.oLanguage.sInfoFiltered.replace("_MAX_",d)+a.oLanguage.sInfoPostFix:a.fnRecordsDisplay()==a.fnRecordsTotal()?a.oLanguage.sInfo.replace("_START_",c).replace("_END_",b).replace("_TOTAL_",f)+a.oLanguage.sInfoPostFix:a.oLanguage.sInfo.replace("_START_",
c).replace("_END_",b).replace("_TOTAL_",f)+" "+a.oLanguage.sInfoFiltered.replace("_MAX_",a.fnFormatNumber(a.fnRecordsTotal()))+a.oLanguage.sInfoPostFix,a=a.aanFeatures.i;if("undefined"!=typeof a){d=0;for(c=a.length;d<c;d++)e(a[d]).html(f)}}}};f.defaults={trace:!1,rowHeight:"auto",serverWait:200,displayBuffer:9,boundaryScale:0.5,loadingIndicator:!1};f.oDefaults=f.defaults;f.version="1.2.1-dev";"function"==typeof e.fn.dataTable&&"function"==typeof e.fn.dataTableExt.fnVersionCheck&&e.fn.dataTableExt.fnVersionCheck("1.9.0")?
