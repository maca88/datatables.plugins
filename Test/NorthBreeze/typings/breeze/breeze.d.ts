...
declare module breeze {
    ...
    class EntityKey {
        constructor (entityType: IStructuralType, keyValue: any);
        constructor(entityType: IStructuralType, keyValues: any[]);
    ...
    class ValidationError {
        ...
        static getKey: (validator: string, property: string) => string;
    ...
    class Validator {
        ...
        static emailAddress(): Validator;
        static creditCard(): Validator;
        static regularExpression(context?: {expression: string}): Validator;
        static maxLength(context: { maxLength: number; }): Validator;
        static number(): Validator;
        static required(context: { allowEmptyStrings: boolean; }): Validator;
        static string(): Validator;
        static stringLength(context?: { maxLength: number; minLength: number; }): Validator;
        
        static register(validator: Validator): void;
        static registerFactory(fn: (ctx?: any) => Validator, name: string): void;
